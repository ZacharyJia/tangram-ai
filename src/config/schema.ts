      ...
      .object({
        defaults: z
          .object({
            ...
            workspace: z.string().min(1).default("~/.tangram-ai/workspace"),
            skills: z
              .object({
                enabled: z.boolean().optional().default(true),
            ...
            shell: z
              .object({
                ...
                roots: z.array(z.string().min(1)).optional().default(["~/.tangram-ai"]),
                defaultCwd: z.string().min(1).optional().default("~/.tangram-ai/workspace"),
            ...
            heartbeat: z
              .object({
                ...
                filePath: z.string().min(1).optional().default("~/.tangram-ai/workspace/HEARTBEAT.md"),
            ...
            cron: z
              .object({
                ...
                storePath: z.string().min(1).optional().default("~/.tangram-ai/workspace/cron-tasks.json"),
